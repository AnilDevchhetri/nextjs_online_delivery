'use client'
import { Eye, EyeOff, Leaf, Loader2, Lock, LogIn, Mail, User } from 'lucide-react'
...
function Login() {
    ...
    return (
        <div className='flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-white relative'>
            ...
            <p className='flex text-grey-600 items-center mb-4'>Sign In <Leaf className='w-5 h-5 text-green-700' /></p>
            <motion.form
                initial={{
            ...
            <p className='text-gray-600 mt-6 text-sm flex items-center gap-1 cursor-pointer' onClick={() => router.push('/register')}>Create New account ? <LogIn className='w-4 h-4' /><span className='text-green-600'> Sign Up</span></p>
        </div>
    )
}
